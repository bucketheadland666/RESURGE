...
import 'package:home_hub/screens/auth/components/SVLoginInComponent.dart';
import 'package:home_hub/screens/auth/components/SVSignUpComponent.dart';

import 'package:home_hub/utils/SVColors.dart';
import 'package:home_hub/utils/SVConstants.dart';
...
class _SVSignInScreenState extends State<SVSignInScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: context.statusBarHeight + 20),
          Row(
